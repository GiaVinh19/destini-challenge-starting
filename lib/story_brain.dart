...
getStory(int storyNumber) {
  return StoryBrain()._storyData[storyNumber].storyTitle;
}

//TODO: Step 11 - Create a method called getChoice1() that returns the text for the first choice1 from _storyData.

getChoice(int storyNumber) {
  return StoryBrain()._storyData[storyNumber].choice1;
}

//TODO: Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.

getChoice2(int storyNumber) {
  return StoryBrain()._storyData[storyNumber].choice2;
}
